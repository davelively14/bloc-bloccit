class QuestionsController < ApplicationController
  ...
  def create
    ...
    if @question.save
      flash[:notice] = "Question '#{@question.title[0..10]}...' was saved."
  ...
  def update
    ...
    if @question.save
      flash[:notice] = "Question '#{@question.title[0..10]}...' was updated."
      redirect_to @question
    else
  ...
  def destroy
    ...
    if @question.destroy
      flash[:notice] = "\"#{@question.title[0..20]}\" was deleted successfully."
