...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "GET #index" do
    ...
    it "assigns question to to @questions" do
      get :index
  ...
  describe "POST #create" do
    it "returns http success" do
      expect{post :create, question: {title: "A", body: "B", resolved: false}}.to change(Question, :count).by(1)
    end

    it "assigns the new question to @question" do
      post :create, question: {title: "A", body: "B", resolved: false}
